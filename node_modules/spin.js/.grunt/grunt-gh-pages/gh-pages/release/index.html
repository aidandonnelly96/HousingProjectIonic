...
<head>
  <meta charset="utf-8"/>
  <title>spin.js</title>
  <meta name="description" content="An animated activity indicator.">
...
<div id="example">
  ...
  <form id="opts">
    ...
    <label>Length:</label><input type="range" name="length" min="0" max="56" value="28"><br>
    <label>Width:</label><input type="range" name="width" min="2" max="52" value="14"><br>
    <label>Radius:</label><input type="range" name="radius" min="0" max="84" value="42"><br>
    <label>Scale:</label><input type="range" name="scale" min="0.0" max="5.0" step="0.25" value="1.0"><br>
...
<h2>Installation</h2>
<p>Run <code>npm install spin.js</code></p>
...
var opts = {
  ...
  color: '<span id="opt-color" class="str">#000</span>', // #rgb or #rrggbb or array of colors
